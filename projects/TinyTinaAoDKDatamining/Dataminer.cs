...
namespace TinyTinaAoDKDatamining
{
    public class Dataminer
    {
        ...
        {
            var processes = Process.GetProcessesByName("tinytina");
        ...
        public void Run(string[] args, Action<Engine> callback)
        {
            ...
            if (process == null)
            {
                Console.WriteLine("Failed to find a suitable running Tiny Tina's Assault on Dragon Keep process.");
                return;
            }
